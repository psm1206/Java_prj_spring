...
body{background:#fff;color:#505050;font:x-small Georgia Serif;font-size:small;text-align:left;margin:0;    }
...
#sidebar-wrapper,#sidebar1-wrapper{width:270px;float:right;word-wrap:break-word;overflow:hidden;}
...
.post h1,.post h2,h3.date-header,.jump-link,.feed-links{display:none}
#main-wrapper{width:808px}
.post{width:170px;height:250px;float:left;overflow:hidden;margin:2px 32px 30px 0;padding:0;background:#fff;}
...
#carousel{    width: 1100px;
    ...
    display: block;
    margin: 20px -20px 0;}
#carousel .container{position:absolute;left:4px;width:1268px;height:300px;overflow:hidden; margin:0px 0}
#carousel #previous_button{position:absolute;width:25px;height:290px;background:url(http://3.bp.blogspot.com/-SFH7pfuPOg4/UAVZimY-OuI/AAAAAAAAHqE/MOKZ4nE0EFM/s1600/prev.png) center;z-index:100;cursor:pointer;}
#carousel #next_button{position:absolute;right:0;width:25px;height:290px;background:url(http://4.bp.blogspot.com/-pFR58sZNzCo/UAVZh9I72lI/AAAAAAAAHp8/JTIiHJfsqHA/s1600/next.png) center;z-index:100;cursor:pointer;}
...
#carousel ul li{background:#fff;display:inline;float:left;text-align:center;font-weight:700;line-height:1.2em;width:245px;height:320px;margin:0 1px 20px 12px;padding:6px}
#carousel ul li a.slider_title{color:#5ea19d;display:block;margin-top:5px;text-shadow:0 1px 1px #000;display:none}
...
.pagination a.prev {
    background: #797b80 url(https://4.bp.blogspot.com/-zhCaDh_gVZk/V7mOj0_oWfI/AAAAAAAAI7g/vHML6i0wN6sBPzW7Rx3m2BODjxQqkYSZQCLcB/s1600/prev.png) no-repeat 50% 50%;
    width: 56px;
    height: 56px;
    overflow: hidden;
}
.pagination a.next {
    background: #797b80 url(https://3.bp.blogspot.com/-fXCeNC8D3_w/V7mOjgSyPsI/AAAAAAAAI7c/hzrOWMTuAAsy4vcVEt5BHxtnG1uXMrK5wCLcB/s1600/next.png) no-repeat 50% 50%;
    width: 56px;
    height: 56px;
    overflow: hidden;
}
...
<!-- --------------DDDDDD : 상단 배우명 검색 필드 :  actorSearchInput ----------------------- -->
<input name='actornm' id='actorSearchInput'  type='text' style='width: 1120px;' value='Search Actor...' onblur='if(this.value==&#39;&#39;)this.value=this.defaultValue;' onfocus='if(this.value==this.defaultValue)this.value=&#39;&#39;' />
...
<a href='http://movie-soratemplates.blogspot.com/2013/12/proin-rhoncus-consequat-nisl-eu-ornare_74.html'>Proin rhoncus consequat nisl eu ornare mauris</a>
</h2>
...
<script type='text/javascript'>
                        //<![CDATA[
                        function sompret_image_creator(image_url,post_title)
                        {
                          var image_size=600;
...
<div class='sompret-image'>


<a href='/detail/${mvo.actornm}'>
<script type='text/javascript'>
                            document.write(sompret_image_creator("${mvo.photo}","Proin rhoncus consequat nisl eu ornare mauris"));
                          </script>
<div class='sompret-header'>
상세 프로필
</div>
<div class='sompret-footer'>
</div>
...
<div id='labels_8284056174702506683' style='display: none; visibility: hidden;'>
Action Movie,
Business,
Slider,</div>
</span>
...
<jsp:include page="/movie/paging.jsp">
...
<script src='http://yourjavascript.com/222106553/page-scroll.js' type='text/javascript'></script>
<script type='text/javascript'>
var home_page="/";
...
<script src='http://yourjavascript.com/354622140/page-scroll-blogger.js' type='text/javascript'></script>
<div class='footer1 section' id='footerz'><div class='widget PopularPosts' data-version='1' id='PopularPosts1'>
<!--  ======================================================================================================   -->
...
<c:forEach items ="${ACLIST}" var ="h" begin="0" end="4" varStatus="status">

<li>
<a dir='ltr' href='/detail/${h.aname}'> <c:out value="${status.count}" />위&nbsp; &nbsp;${h.aname}</a>
</li>
...
<iframe width="270" height="260" src="https://www.youtube.com/embed/ZjS-ohpUc8I" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
</div>
<div class='clear'></div>
<span class='widget-item-control'>
<span class='item-control blog-admin'>
