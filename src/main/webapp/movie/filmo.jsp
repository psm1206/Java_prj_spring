...
<meta content='http://movie-soratemplates.blogspot.com/2013/12/proin-rhoncus-consequat-nisl-eu-ornare_74.html' property='og:url'/>
...
jQuery(document).ready(function() {	
	...
	$("#actorSearchInput").keydown(function(key) {
		if (key.keyCode == 13) {
			...
			location.href = "/filmo/"+$("#actorSearchInput").val();
		}
	});
...
<a href='http://movie-soratemplates.blogspot.com/'>Home</a> &#187;
                  
<a href='http://movie-soratemplates.blogspot.com/search/label/Action%20Movie' rel='tag'>Action Movie</a>
 , 
<a href='http://movie-soratemplates.blogspot.com/search/label/Business' rel='tag'>Business</a>
 , 
<a href='http://movie-soratemplates.blogspot.com/search/label/Slider' rel='tag'>Slider</a>
 &#187; Proin rhoncus consequat nisl eu ornare mauris
</div>
<div class='post hentry'>
<div id='judul-post'>
<script type='text/javascript'>
                      var timestamp="Saturday, December 14, 2013";
                      if(timestamp!="") {
...
<span style = " font-weight: bold; font-size:1.5em; ">배우 ${FVO[0].aname}의 Filmography</span>
</h1></div>
...
<div class="filmoacc" id="tab_a">
    <div class="fboxin">
	   							
<c:forEach items = "${FVO}" var = "fvo">

		<div class="filin" style="float: left; width: 50%; ">
		<div class="filmo" style="text-align: center;">
		<a href="javascript:youtubeOpen('https://www.youtube.com/results?search_query=영화 ${fvo.title}')">
            <img src= "${fvo.poster}" title="${fvo.title} 포스트이미지" width="300" height="428" /></a>
		</div>
        
		<div class="filinfo" style="text-align: center;">
			<p class="fitit">
				<a href="javascript:youtubeOpen('https://www.youtube.com/results?search_query=영화 ${fvo.title}')">
				<span style = " font-weight: bold; font-size:1.5em; ">${fvo.title}
				</span></a>
			</p>
			<p class="fiyear">
                <span class="fipeo year">개봉년도 : ${fvo.year}</span>
            </p>
            <p class="fitxt">
                <span class="fipeo pno">관객수 : ${fvo.audi}명</span>
            </p>
            <p class="fistar">
                <span class="bstr"><em style="width:0%"></em></span>
                <span class="pstrn">평점 : ${fvo.rating}</span><br><br><br>
            </p>
...
function youtubeOpen(prmURL) {
	window.open( prmURL, "openWin", "width:1500, scrollbars=yes");
}
(function(d, s, id) {
...
<a class='twitter-share-button' data-count='horizontal' data-lang='en' data-related='' data-text='Proin rhoncus consequat nisl eu ornare mauris' data-url='http://movie-soratemplates.blogspot.com/2013/12/proin-rhoncus-consequat-nisl-eu-ornare_74.html' data-via='' href='https://twitter.com/share'>Tweet</a>
</div>
<div style='float:left;'>
<g:plusone annotation='bubble' href='http://movie-soratemplates.blogspot.com/2013/12/proin-rhoncus-consequat-nisl-eu-ornare_74.html' size='medium'></g:plusone>
</div>
<div style='float:left;'>
<fb:like colorscheme='light' font='' href='http://movie-soratemplates.blogspot.com/2013/12/proin-rhoncus-consequat-nisl-eu-ornare_74.html' layout='button_count' send='true' show_faces='false'></fb:like>
</div>
...
<meta content='http://movie-soratemplates.blogspot.com/2013/12/proin-rhoncus-consequat-nisl-eu-ornare_74.html' itemprop='url mainEntityOfPage'/>
<a class='timestamp-link' href='http://movie-soratemplates.blogspot.com/2013/12/proin-rhoncus-consequat-nisl-eu-ornare_74.html' rel='bookmark' title='permanent link'><abbr class='published' itemprop='datePublished dateModified' title='Saturday, December 14, 2013'>Saturday, December 14, 2013</abbr></a>
</span>
